...
class Model
  ...
  #method to perform operation on model file
  ...
  #method to singularize the model_name
  ...
  #method to get model attrubutes from command-line arguments
  ...
  #method to check validations on command-line arguments
  ...
  #methods to split command-line argument as data_type and column_name
  ...
  #method to write attributes in model file
