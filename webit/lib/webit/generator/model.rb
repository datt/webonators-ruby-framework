...
class Model
  ...
  #method to checkout validations on command-line argument
  ...
  #method to split argument as data type and column name(eg. string:name)
  ...
  #method to set column and write attributes in model class
  ...
  #method to get file name from argument
